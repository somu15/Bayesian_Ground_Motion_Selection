...
%  (GMPM is Boore-Atkinson 2008; only large magnitude earthquakes)
...
function [X] = BA_X_Large_M(magnitude, Rjb, Vs, SS, N, R, U, M_ref, R_ref, M_h, Vs_ref, h)
...
X = [U SS N R e_7 log(R_R/R_ref) (magnitude-M_ref).*log(R_R/R_ref)...
    R_R-R_ref log(Vs/Vs_ref)];
